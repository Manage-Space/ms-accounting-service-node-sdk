...
export class CreateFeeIncomeRulesRequest {
    /**
    * Fee income rules
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "feeIncomeRules",
            "baseName": "feeIncomeRules",
            "type": "Array<CreateFeeIncomeRuleRequest>"
        }    ];

    static getAttributeTypeMap() {
        return CreateFeeIncomeRulesRequest.attributeTypeMap;
    }
}
